...
def introStory():
    ...
    print(' ')
    print('The familiar words "I will clean that later" enter you mind')
    print(' ')
...
def workPath():
    ...
    print('laziness you never got around to it')
    print('\n' * 2)
    input('                     press enter')
    print('\n' * 4)
    ...
    print(' ')
    print('You grab chains, chairs, hammers, what ever you could to bare the door and start making enough noise to wake up the whole building')
    print('\n' * 2)
    input('                     press enter')
    print('\n' * 4)
    print('In you moment of insanity you hear loud banging on the other side of the door you were just trying to lock down.')
    print(' ')
    print('You come to your senses for a moment and decide to open the door.')
    print(' ')
    print('You weakly push aside as much garbage that you piled in front of the door aside and start trying to open the door.')
    print(' ')
    print(' ')
    print('You see your roommate Josh on the other side of the door...')
    print('\n' * 2)
    input('                     press enter')
    print('\n' * 4)
    print(f'"What the fuck are you doing in there {playerName}?"')
    print(' ')
    print('you say "hold on" and close the door and start pushing more things out of the way')
    print(' ')
    print('you here Josh walking Steve up in the next room "Yo! how are you sleeping through all that noise?"')
    print(' ')
    print('You finally have enough out of the way of the door that you think you can open it so you try again with success')
    print('\n' * 2)
    input('                     press enter')
    print('\n' * 4)
